...
public class Crawler implements Runnable{
    ...
    public Crawler(List<String> URL_list, List<String> comp, List<String> visit, int numthreads,List<Document> doc) throws IOException {
        list=URL_list;
        Compact=comp;
        visited=visit;
...
//        Compact.close();
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (int i=0;i<number_of_threads;i++) {
            ...
            Thread th=new Thread(new Crawler(list_c,comp_str,list_visit,number_of_threads,documents));
...
//            C.compact_string("https://jsoup.org/cookbook/extracting-data/example-list-links");
        ...
        Thread th=new Thread(new Indexer(documents,db,visited));
        th.join();
